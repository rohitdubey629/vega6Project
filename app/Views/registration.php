...
<body id="page-top">
	<div class="wrapper">
		...
		<div class="text-center mt-4 name">Registration Page</div>

		<form class="p-3 mt-3" method="post" autocomplete="off" id="regis_form">
			...
			<button class="btn mt-3" style="cursor: pointer;">Registration</button>
		</form>
...
<script>
	$(document).ready(function() {
		$("#regis_form").submit(function(e) {
			...
			$.ajax({
				type: "POST",
				url: "<?php echo base_url("user_regis") ?>",
