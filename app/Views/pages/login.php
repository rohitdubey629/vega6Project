...
<body id="page-top">
	<div class="wrapper">
		...
		<form class="p-3 mt-3" method="post" autocomplete="off" id="login_form">
			...
			<button class="btn mt-3" style="cursor: pointer;">Login</button>
		</form>
		<div class="text-center fs-6">
			<a href="<?php echo base_url("fPassword") ?>">Forget password?</a> &nbsp;
			<a href="<?php echo base_url("home") ?>">Registration</a>
		</div>
