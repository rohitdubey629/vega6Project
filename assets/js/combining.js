...
!(function (e) {
    ...
    d =
      ...
      (n = function () {
        t <= 991 &&
          ...
          jQuery(".full-sidenav .navbar-nav > li > a")
            .next(".sub-menu")
            .slideUp(),
          jQuery(".full-sidenav .sub-menu > li > a")
            .next(".sub-menu")
            .slideUp(),
          jQuery(
        ...
        e(t).each(function () {
          if (
            ...
            for (currentDiv = 0; currentDiv < r.length; currentDiv++)
              r[currentDiv].height(n);
            (r.length = 0), (a = topPostion), (n = i.height()), r.push(i);
      ...
      (o = function () {
        e(".openbtn").on("click", function (t) {
          t.preventDefault(),
            e("#mySidenav").length > 0 &&
              (document.getElementById("mySidenav").style.left = "0"),
            e("#mySidenav1").length > 0 &&
      ...
      (l = function () {
        e(".header-nav li")
          ...
          .each(function (t) {
            if (e("ul", this).length) {
              var i = e("ul:first", this),
                n = i.offset().left,
                a = i.width();
              e("body").height();
              n + a <= e("body").width()
                ? e(this).find(".sub-menu:first").removeClass("left")
                : e(this).find(".sub-menu:first").addClass("left");
            }
          });
      }),
      (s = function () {
        ...
        e(window).on("scroll", function () {
          e(".split-box").each(function () {
            ...
            (t = e(this)),
              ...
              (a = n.scrollTop()),
              (r = a + n.height()),
              (o = i.offset().top) + i.height() <= r &&
                o >= a &&
                e(this).addClass("split-active");
          });
        });
      }),
        ...
        init: function () {
          ...
          jQuery(".box-hover").on("mouseenter", function () {
            ...
            e(".price-slide, .price-slide-2").length > 0 &&
              e("#slider-range,#slider-range-2").slider({
                range: !0,
                min: 300,
                max: 4e3,
                values: [0, 5e3],
            ...
            jQuery(".mfp-gallery-with-owl").length &&
            ...
            e(".popup-youtube, .popup-vimeo, .popup-gmaps").length &&
            ...
            jQuery(".dezPlaceAni").length &&
              (e(".dezPlaceAni input, .dezPlaceAni textarea").on(
                "focus",
                function () {
                  e(this).parents(".form-group, .news-box").addClass("focused");
                }
              ),
              e(".dezPlaceAni input, .dezPlaceAni textarea").on(
                "blur",
            ...
            jQuery(window).on("scroll", function () {
              if (jQuery(".sticky-header").length > 0) {
                ...
                e(window).scrollTop() > t.offset().top
                  ? (t.addClass("is-fixed"),
                    e(
                      ".header-smartClass .container > .logo-header .logo"
            ...
            jQuery(".gallery-filter.masonary").length &&
              jQuery(".gallery-filter.masonary").on(
                "click",
                "span",
                function () {
            ...
            e(".content-scroll").length &&
              e(".content-scroll").mCustomScrollbar({
                setWidth: !1,
                setHeight: !1,
                axis: "y",
              }),
            ...
            (l = parseInt(e(".onepage").css("height"), 10)),
            e(".scroll")
              .unbind()
              .on("click", function (t) {
          ...
          t > 1023 &&
            ...
            (function () {
              ...
              jQuery(".filters").length &&
                jQuery(".filters").on("click", "li", function (i) {
                  i.preventDefault();
                  var n = e(this).attr("data-filter");
                  t.masonryFilter({
                    filter: function () {
                      return !n || e(this).hasClass(n);
                    },
                  });
                });
            })(),
  ...
  jQuery(document).ready(function () {
    d.init(),
      ...
      e('a[data-toggle="tab"]').on("click", function () {
        e('a[data-toggle="tab"]').on("click", function () {
          e(e(this).attr("href"))
            .show()
...
!(function (t) {
  ...
  jQuery(document).ready(function () {
    ...
    (window.verifyRecaptchaCallback = function (e) {
      t("input[data-recaptcha]").val(e).trigger("change");
    }),
      (window.expiredRecaptchaCallback = function () {
        t("input[data-recaptcha]").val("").trigger("change");
      }),
      t(".dzForm").on("submit", function (a) {
        a.preventDefault(),
          t(".dzFormMsg").html(
        ...
        t.ajax({
          ...
          success: function (a) {
            1 == a.status &&
              (e = '<div class="gen alert alert-success">' + a.msg + "</div>"),
              0 == a.status &&
                (e = '<div class="err alert alert-danger">' + a.msg + "</div>"),
              t(".dzFormMsg").html(e),
              t(".dzForm")[0].reset(),
              grecaptcha.reset();
          },
      ...
      setInterval(function () {
        t(".dzFormMsg .alert").hide(1e3);
      }, 1e4),
      t(".dzSubscribe").on("submit", function (a) {
        a.preventDefault();
        var s = t(this).attr("action"),
          r = t(this).serialize();
        t.ajax({
          ...
          success: function (a) {
            1 == a.status &&
              (e = '<p style="color: #34A853">' + a.msg + "</p>"),
              0 == a.status &&
                (e = '<p style="color: #EA4335">' + a.msg + "</p>"),
              t(".dzSubscribeMsg").html(e),
              t(".dzSubscribe")[0].reset();
          },
        });
      }),
      setInterval(function () {
        t(".dzSubscribeMsg p").hide(1e3);
      }, 5e3);
  });
})(jQuery);
